...
const Footer = () => {
  return (
    <div className='w-full flex  flex-col justify-between  gap-6 mt-10'>
        <div className="flex flex-col sm:flex-row justify-between">
             <div className="flex flex-col  gap-2">
                ...
                <p  className='text-xs w-full md:w-1/4'> Otino is a simple online platform where students can share, buy, and sell quality study notes. It makes learning easier while helping creators earn from their knowledge. </p>
            </div>
    ...
    <div className="flex flex-col sm:flex-row  w-full  justify-rounded gap-10 text-center items-center text-xs">
